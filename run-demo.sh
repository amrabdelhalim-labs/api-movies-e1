...
IMAGE="${DEMO_IMAGE:-ghcr.io/amrabdelhalim-labs/api-movies-e1:v1.0.1}"
DEFAULT_PORT="${DEMO_PORT:-3000}"
CONTAINER_PORT="3000"
READY_PATH="/"
PREVIEW_PATH="/api-docs"
...
while [ "$port" -le "$last_port" ]; do
  container_name="api-movies-e1-demo-${port}-$$"
